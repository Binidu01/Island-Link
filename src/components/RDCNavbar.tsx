...
export default function RDCNavbar() {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
      ...
      if (currentUser) {
        try {
          ...
          setUserName(currentUser.displayName || currentUser.email?.split('@')[0] || 'RDC Staff')
          ...
          if (userDoc.exists()) {
            ...
            setUserRole(userData.role || 'RDC Staff')
  ...
  const getRoleDisplay = () => {
    if (userRole === 'RDC Staff') return 'RDC Staff'
    return userRole || 'RDC'
  }
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Logo & Title */}
            <a href="/rdc" className="flex items-center gap-3 group shrink-0">
              ...
              <div className="leading-tight hidden sm:block">
                ...
                <div className="text-xs text-gray-500">Regional Distribution Center</div>
              </div>
            </a>
        ...
        <>
          ...
          <div className="fixed top-0 left-0 bottom-0 w-72 max-w-[80vw] bg-white z-[70] shadow-2xl lg:hidden animate-slide-in-left overflow-y-auto flex flex-col">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              <a href="/rdc" onClick={closeMobileMenu} className="flex items-center gap-3">
              ...
              <div className="p-4 border-b border-gray-200 bg-linear-to-br from-green-50 via-blue-50 to-purple-50">
                <a href="/profile" onClick={closeMobileMenu} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600 truncate">{user.email}</p>
                    <span className="inline-block mt-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-linear-to-r from-green-500 to-blue-600 text-white">
                      {getRoleDisplay()}
                    </span>
                  </div>
                  <svg
            ...
            <div className="p-3 border-t border-gray-200 mt-auto">
              {user ? (
                ...
                <a
                  href="/login"
                  onClick={closeMobileMenu}
                  className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-linear-to-r from-green-400 to-blue-500 text-white font-bold hover:from-green-500 hover:to-blue-600 transition shadow-sm"
                >
                  Login
                </a>
              )}
