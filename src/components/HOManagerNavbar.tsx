...
export default function HOManagerNavbar() {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
      ...
      if (currentUser) {
        try {
          ...
          setUserName(currentUser.displayName || currentUser.email?.split('@')[0] || 'Manager')
          ...
          if (userDoc.exists()) {
            ...
            setUserRole(userData.role || 'HO Manager')
  ...
  const getRoleDisplay = () => {
    if (userRole === 'HO Manager') return 'Head Office Manager'
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Logo & Title */}
            <a href="/ho-manager" className="flex items-center gap-3 group shrink-0">
              <div className="h-10 w-10 rounded-xl overflow-hidden flex items-center justify-center group-hover:scale-105 transition">
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      parent.innerHTML =
                        '<div class="h-10 w-10 rounded-xl bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center font-black text-white text-xl">IL</div>'
                    }
                  }}
                />
              </div>
              <div className="leading-tight hidden sm:block">
                <div className="font-bold bg-linear-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
                  IslandLink HQ
                </div>
                <div className="text-xs text-gray-500">Head Office Management</div>
              </div>
            </a>
            ...
            <div className="hidden lg:flex items-center gap-2">
              {loading ? (
                  ...
                  {showProfileMenu && (
                    <>
                      ...
                      <div className="absolute right-0 mt-2 w-56 rounded-2xl border border-gray-200 bg-white shadow-xl z-50 overflow-hidden">
                        <div className="p-4 border-b border-gray-200 bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
                          <p className="font-semibold text-gray-900">{getUserDisplayName()}</p>
                          <p className="text-xs text-gray-600 truncate">{user.email}</p>
                          <span className="inline-block mt-2 px-2 py-1 rounded-full text-xs font-semibold bg-linear-to-r from-blue-500 to-purple-600 text-white">
                            {getRoleDisplay()}
                          </span>
                        </div>
                ...
                <a
                  href="/login"
                  className="px-5 py-2 rounded-xl bg-linear-to-r from-blue-400 to-purple-500 text-white text-sm font-bold hover:from-blue-500 hover:to-purple-600 transition shadow-sm"
                >
                  Login
                </a>
              )}
        ...
        <>
          ...
          <div className="fixed top-0 left-0 bottom-0 w-72 max-w-[80vw] bg-white z-[70] shadow-2xl lg:hidden animate-slide-in-left overflow-y-auto flex flex-col">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              <a href="/ho-manager" onClick={closeMobileMenu} className="flex items-center gap-3">
              ...
              <div className="p-4 border-b border-gray-200 bg-linear-to-br from-blue-50 via-purple-50 to-pink-50">
                <a href="/profile" onClick={closeMobileMenu} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600 truncate">{user.email}</p>
                    <span className="inline-block mt-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-linear-to-r from-blue-500 to-purple-600 text-white">
                      {getRoleDisplay()}
                    </span>
                  </div>
                  <svg
            ...
            <div className="p-3 border-t border-gray-200 mt-auto">
              {user ? (
                ...
                <a
                  href="/login"
                  onClick={closeMobileMenu}
                  className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-linear-to-r from-blue-400 to-purple-500 text-white font-bold hover:from-blue-500 hover:to-purple-600 transition shadow-sm"
                >
                  Login
                </a>
              )}
